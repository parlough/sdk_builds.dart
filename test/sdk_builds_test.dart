...
void main() async {
  ...
  test('get version', () async {
    ...
    final version = await _dd.getVersion(channel, revision);
  ...
  test('get version paths', () async {
    ...
    final paths = await _dd.getVersionPaths(channel).toList();
  ...
  test('getVersions', () async {
    final versions = await _dd.getVersions('stable');
  ...
  group('getVersion', () {
    test('recent git build', () async {
      ...
      final content = await _dd.getVersion(channel, revision) as GitVersionInfo;
    ...
    test('recent svn build', () async {
      ...
      final content = await _dd.getVersion(channel, revision) as SvnVersionInfo;
    ...
    test('old revision with old date format', () async {
      ...
      final content = await _dd.getVersion('dev', '30039') as SvnVersionInfo;
  ...
  test('getLink', () async {
    ...
    final content = await _dd.getDownloadLink(
